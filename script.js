...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Event Listeners ---
    resultsTableBody.addEventListener('click', (e) => { /* ... (código sin cambios) ... */ });
    imageDisplay.addEventListener('dblclick', () => { /* ... (código sin cambios) ... */ });
    let searchTimeout;
    searchInput.addEventListener('keyup', (e) => { /* ... (código sin cambios) ... */ });
